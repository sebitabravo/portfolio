...
const aboutMeData = {
  es: {
    ...
    personal: `Estudio Ingeniería Informática en INACAP desde 2023 y sigo aprendiendo desde la práctica: desde cómo un ESP32 transmite telemetría hasta cómo una plataforma llega a producción. Si tu equipo valora curiosidad, criterio y gente que se ensucia las manos, hablemos.`,
    signature: `No hago tutoriales de Todo List.`,
    interests: [
    ...
    lookingFor: `Busco mi primer rol full-time como Desarrollador Full-Stack Junior. Me motivan los proyectos que resuelven problemas concretos con tecnología bien aplicada — TypeScript, Python, cloud y testing automatizado.`,
  },
  en: {
    ...
    personal: `I'm a Computer Engineering student at INACAP since 2023 and keep learning through practice: from how an ESP32 transmits telemetry to how a platform reaches production. If your team values curiosity, judgment and technical depth, let's talk.`,
    signature: `I don't build Todo List tutorials.`,
    interests: [
