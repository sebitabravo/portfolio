...
export function createPointerMotion(gsap: (typeof import("gsap"))["gsap"], root: MotionRoot): Cleanup {
...
export function createCardTilt(gsap: (typeof import("gsap"))["gsap"], card: HTMLElement): Cleanup {
